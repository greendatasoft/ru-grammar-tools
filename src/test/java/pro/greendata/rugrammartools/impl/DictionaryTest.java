...
public class DictionaryTest {
    ...
    public void testFindNoun() {
        NounDictionary.Word w1 = Dictionary.getNounDictionary().wordDetails("сапог").orElseThrow(AssertionError::new);
        NounDictionary.Word w2 = Dictionary.getNounDictionary().wordDetails("птица").orElseThrow(AssertionError::new);
