...
public class NumeralTest {
    ...
    public void testNumeralMaleOne() {
        testNumerical((s, c) -> engine.inflect(s, WordType.NUMERALS, c, Gender.MALE, null, false),
    ...
    public void testNumeralFemaleOne() {
        testNumerical((s, c) -> engine.inflect(s, WordType.NUMERALS, c, Gender.FEMALE, null, false),
    ...
    public void testNumeralNeuterOne() {
        testNumerical((s, c) -> engine.inflect(s, WordType.NUMERALS, c, Gender.NEUTER, null, false),
    ...
    public void testNumeralPluralThousandFirstForm() {
        testNumerical((s, c) -> engine.inflect(s, WordType.NUMERALS, c, Gender.FEMALE, null, true),
